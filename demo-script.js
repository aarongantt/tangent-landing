...
(function() {
    ...
    const FAQ_ANSWERS = {
        ...
        'pricing': 'Tangent offers two subscription tiers: Pro ($12/month or $144/year) with 6,000 queries per month, and Business Solo ($30/month or $306/year) with 15,000 queries per month. A 7-day free trial with 1,000 queries is available. Tangent automatically selects the optimal AI model for each task—no manual switching required.',
