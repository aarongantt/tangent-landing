...
(function() {
    ...
    const FAQ_ANSWERS = {
        ...
        'pricing': 'Tangent offers two subscription tiers: Pro ($10/month or $105/year) with 12M standard tokens and 500K deep tokens per month, and Business Solo ($29/month or $290/year) with 20M standard tokens and 1M deep tokens per month. A 7-day free trial with 70,000 standard tokens is available—enough for approximately 150-200 typical interactions. One-time token packs are also available if you need more.',
